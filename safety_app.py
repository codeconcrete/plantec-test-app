...
if "app_init_toast" not in st.session_state:
    st.toast("✅ 로컬 AI 서버에 자동 연결되었습니다!", icon="🚀")
    st.session_state.app_init_toast = True

# 2. 데이터 로드 및 초기화
# 시연용 체험판이므로 API 키를 코드 실행 시 강제로 주입합니다.
api_key = "AIzaSyAZVXaYQoM-L3lOWq2_rgr9uGiZ6LH4E3E"
